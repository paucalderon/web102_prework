...
gamesCard.innerHTML =
    `<h2>${totalGames.toLocaleString()}</h2>`
    ;
...
const word = numUnfunded == 1 ? "game" : "games";

let displayStr = `A total of $${totalRaised.toLocaleString()} has been raised for ${totalGames} games. There are ${numUnfunded} ${word} that remain unfunded.`;
